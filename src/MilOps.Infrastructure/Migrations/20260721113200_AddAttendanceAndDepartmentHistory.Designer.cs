...
namespace MilOps.Infrastructure.Migrations
{
    ...
    [Migration("20260721113200_AddAttendanceAndDepartmentHistory")]
    partial class AddAttendanceAndDepartmentHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MilOps.Domain.Entities.AttendanceRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("MilOps.Domain.Entities.DepartmentHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("SoldierId", "EffectiveFrom");

                    b.ToTable("department_history", (string)null);
                });
            ...
            modelBuilder.Entity("MilOps.Domain.Entities.AttendanceRecord", b =>
                {
                    b.HasOne("MilOps.Domain.Entities.Soldier", null)
                        .WithMany()
